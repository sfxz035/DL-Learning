...
- **提高精度**   
  ...
  - **Convolutional With Anchor Boxes.**    
     YOLO(v1)使用全连接层数据进行bounding box预测（要把1470*1的全链接层reshape为7*7*30的最终特征），这会丢失较多的空间信息定位不准。YOLOv2借鉴了Faster R-CNN中的anchor思想,即RPN思想：
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUyNDI5MzUwMCwtMzUyNzE2MjAyLC01Nz
