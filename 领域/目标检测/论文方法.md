...
- **提高精度**   
  ...
  - **Convolutional With Anchor Boxes.**    
     YOLO(v1)使用全连接层数据进行bounding box预测（要把1470*1的全链接层reshape为7*7*30的最终特征），这会丢失较多的空间信息定位不准。YOLOv2借鉴了Faster R-CNN中的anchor思想,即RPN思想。直接卷积得到7*7*30
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ4MDczNjIzOSwtMzUyNzE2MjAyLC01Nz
U0NzU0NTgsLTkyODIwMDcxNCwyMTEwNDAwNzk5LC0xMjM4Nzk0
MzMwLDg5OTg4NjE2LC0xNTg0Mjg2NDExLDgwNDQ1MzI4MCwtNz
A3Njc5NTAxLDE0MzA3ODMwODQsNzQyMDMzNjM3LDEyODExMzg2
MjcsLTYxMjMyNDIwLC02MjEwMzQ0MzIsNzM0MDYyNjM4LDEwMz
YwMDk3MzEsLTIxNjU4NzI5NSwxNjc0MzA0MDcyLC02NDY1OTg2
MTldfQ==
-->