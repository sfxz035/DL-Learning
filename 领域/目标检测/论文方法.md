...
- **提高精度**   
  ...
  - **Convolutional With Anchor Boxes.**    
     YOLO(v1)使用全连接层数据进行bounding box预测（要把1470x1的全链接层reshape为7x7x30的最终特征），这会丢失较多的空间信息定位不准。YOLO v2 借鉴了Faster R-CNN中的anchor思想,即RPN思想。直接卷积得到7x7x30。
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAxNTMxNTI2NSwxNDgwNzM2MjM5LC0zNT
I3MTYyMDIsLTU3NTQ3NTQ1OCwtOTI4MjAwNzE0LDIxMTA0MDA3
OTksLTEyMzg3OTQzMzAsODk5ODg2MTYsLTE1ODQyODY0MTEsOD
A0NDUzMjgwLC03MDc2Nzk1MDEsMTQzMDc4MzA4NCw3NDIwMzM2
MzcsMTI4MTEzODYyNywtNjEyMzI0MjAsLTYyMTAzNDQzMiw3Mz
QwNjI2MzgsMTAzNjAwOTczMSwtMjE2NTg3Mjk1LDE2NzQzMDQw
NzJdfQ==
-->