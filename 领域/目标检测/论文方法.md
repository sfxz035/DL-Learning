...
- 网络结构
- 重要要点：  
  输出为**:S×S×(B×5+C)个预测值**，即7×7×(2×5+20)，即最终的输出为7×7×307×7×30的张量
  - 分成单元格  
    首先会把原始图片**resize到448×448**，放缩到这个尺寸是为了后面整除来的方便。再把整个图片**分成S×S**(例:7×7)个单元格，此后以每个单元格为单位进行预测分析。
  - 
- 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkzMTEzODY3NywtMTk2MzEwNjAxNSwxNj
cyNzIxMTM2LC0xMDI5MTAzMDYsMzc2NzkxMzMyLDEyMjA2OTc2
NDAsLTEwNzE5MTQ3ODMsOTc5MzMwNzMwLC04MjU0NTIwNTMsLT
M0NTEyMDMyNiwxOTUzNTA2ODA0LC0yMjc3ODIwOTYsMTAyMjcx
MzMyOCw4MDg0Nzk1ODUsLTU2MTU4MjYyMyw3OTUxODA0ODgsLT
IxMjAwNTYyODUsLTE3Mzk0Nzg4MjcsLTE0MjM5NjE3NzEsLTEw
OTUwMzU3NThdfQ==
-->