...
## patch GAN  
   基于条件gan   
 - 方法  
  判别器判别时，加入条件输入(即生成器输入)，对判别器进行一个约束，从而达到对生成器的约束。   
   其中z为输入，x为条件输入。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ5Njc2Mjk2NiwtOTMyNDYwNjI4LC03NT
c0MDE5OTEsLTc0ODQxMTk4MSwxODM1NzcyMzE5LDI3NjgyMDkw
LC0xMzI3ODgzMDY1LDQ1MDE5NDc5NCwtMTM1MzEzMTQxOCwxNj
MwOTc1NDY3LDExOTM4OTUwNTAsLTExOTM1MTQ1ODcsOTU2Njcw
MDA3XX0=
-->