...
- 改动  
  将原始GAN中的概率全改成了条件概率，  
  $\displaystyle\max _{D} \left \{  \right \}$
  E_{x y}[logD(x,y)]+E_{x,z}[log(1−D(x,G(x,z)))]
## patch GAN  
   基于条件gan   
 - **方法**    
  该方法使用的是配对数据。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg5MTY4NDk3NywtMTk0NjQ5MjMxNywxMT
E3ODAxODgxLC0xODE0MjgxMTM0LDY5OTI3Nzc3MSwyMDYwODg5
ODIyLDEyMDQ4NjQxOTMsLTU1NTY3Njk3NCw2NTk0NzUyMTcsMT
EwMTYwODYzMSw2ODQ4Mjg0MzIsLTEyNTc5ODIyMDgsLTQyNDY5
NDcyMiwtOTMyNDYwNjI4LC03NTc0MDE5OTEsLTc0ODQxMTk4MS
wxODM1NzcyMzE5LDI3NjgyMDkwLC0xMzI3ODgzMDY1LDQ1MDE5
NDc5NF19
-->