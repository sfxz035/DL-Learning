...
- 原始GAN形式训练中的问题   
  ...
  - **最小化第二种生成器loss函数，会等价于最小化一个不合理的距离衡量，导致两个问题，一是梯度不稳定，二是collapse mode即多样性不足**  
     ...
     第二种生成器损失指的是$E_{x-g}[-log(D(x))]$  ,其中g为生成器分布
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAyMTI5OTQ2OCw2NDMwMTEwODEsMjEzMD
Q5Njg0NCwtMjE0NDc0NDAwMCw4OTczNDQ3NzcsLTI2OTg2NDAy
Miw2ODU3NDg3ODksMTA5NjgzNjM0MCw3MDQ1MTA3MTIsNDI2NT
c4MDQwLC0yMTE0NDExNDIsLTEwNTkyODEyODksLTYwNTgwMDgx
MCw2MTkzODc5MjMsLTk5MDY1ODgyNiw2NTc0MzUxNTksMTYwOT
UxMTg5NSw2MDYyMTg1ODMsNDI4MjkxOTAyLDEwMjM4MTQxODNd
fQ==
-->