...
- 改动  
  将原始GAN中的概率全改成了条件概率，  
  $\displaystyle\max _{D}E_{x y}[logD(x,y)]+E_{x,z}[log(1−D(x,G(x,z)))]$
## patch GAN  
   基于条件gan   
 - **方法**    
  该方法使用的是配对数据。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODE5MDM1NDkyLC0xOTQ2NDkyMzE3LDExMT
c4MDE4ODEsLTE4MTQyODExMzQsNjk5Mjc3NzcxLDIwNjA4ODk4
MjIsMTIwNDg2NDE5MywtNTU1Njc2OTc0LDY1OTQ3NTIxNywxMT
AxNjA4NjMxLDY4NDgyODQzMiwtMTI1Nzk4MjIwOCwtNDI0Njk0
NzIyLC05MzI0NjA2MjgsLTc1NzQwMTk5MSwtNzQ4NDExOTgxLD
E4MzU3NzIzMTksMjc2ODIwOTAsLTEzMjc4ODMwNjUsNDUwMTk0
Nzk0XX0=
-->