...
- 改动  
  ...
  $max_D{E_{x,y}[logD(x,y)]+E_{x,z}[log(1−D(x,G(x,z)))]}$
## patch GAN  
   基于条件gan   
 - **方法**    
  该方法使用的是配对数据。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQzOTQ2ODcyMSwxMTE3ODAxODgxLC0xOD
E0MjgxMTM0LDY5OTI3Nzc3MSwyMDYwODg5ODIyLDEyMDQ4NjQx
OTMsLTU1NTY3Njk3NCw2NTk0NzUyMTcsMTEwMTYwODYzMSw2OD
