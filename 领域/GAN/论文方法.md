...
- 实施  
   ...
   gradient = tf.gradients(self.discriminator(interpolated_input, reuse = True), [interpolated_input])[0]   GP_loss = tf.reduce_mean(tf.square(tf.sqrt(tf.reduce_mean(tf.square(gradient), axis = [1, 2, 3])) - 1))
   ```
## CGAN  
- 原因  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NDUwMTc0NzgsMTEwMTYwODYzMSw2OD
Q4Mjg0MzIsLTEyNTc5ODIyMDgsLTQyNDY5NDcyMiwtOTMyNDYw
NjI4LC03NTc0MDE5OTEsLTc0ODQxMTk4MSwxODM1NzcyMzE5LD
I3NjgyMDkwLC0xMzI3ODgzMDY1LDQ1MDE5NDc5NCwtMTM1MzEz
MTQxOCwxNjMwOTc1NDY3LDExOTM4OTUwNTAsLTExOTM1MTQ1OD
csOTU2NjcwMDA3XX0=
-->