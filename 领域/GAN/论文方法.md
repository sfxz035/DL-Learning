...
### **损失**  
   ...
   - object function为：  
    ...
    - 小结  
      GAN其实是一种相对于L1 loss更好的判别准则或者loss。有时候单独使用GAN loss效果好，有时候与L1 loss配合起来效果好。在pix2pix中，作者就是把L1 loss 和GAN loss相结合使用，因为作者认为L1 loss 可以恢复图像的低频部分，由于L1对而GAN loss可以恢复图像的高频部分
## cycleGAN  
   该网络针对非成对数据。   
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDk5ODY2MTkyLDEwMjM4MTQxODMsMTIxNT
