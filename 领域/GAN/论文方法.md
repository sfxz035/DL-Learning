...
### **主要内容**  
   ...
   - **多尺度判别器**    
      ...
      为了解决这个问题，本文提出了一个多尺度判别器。使用三个有相同结构的判别器D1,D2,D3，但对于不同尺度图像进行判别。通过以2倍，4倍降采样真实图像和合成图像，获得三个尺度信息。D1,D2,D3分别再三个不同尺度上训练。虽然三个判别器结构相同，但是在最粗的尺度有最大的感受野，   
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU5NjA3ODkxOCw2NTAyNzU2OTAsLTg5ND
g5MjE3NiwtMTg0NzI2MjU1Niw3NjEyMjkzMTksLTE1ODEzNzQ2
MjIsODc4MjI3NjAzLC03NjExNTU1NjMsNTc1NDAzOTcsMTEwMj
E2NjE5LDE2NTI4Njk1NSwtMTgyMjExNzI2MSwxMzU0MzgwOTE2
LC01NTIxNzUzODcsNjQzMDExMDgxLDIxMzA0OTY4NDQsLTIxND
