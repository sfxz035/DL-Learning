...
- 原因  
 ...
 - 判别器结构  
   ...
   - 好处  
    ...
    - 效果对比   
       论文对比了不同大小patch的结果，对于256x256的输入，patch大小在70x70的时候，从视觉上看结果就和直接把整张图片作为判别器输入没有多大区别了，但70x70。
## patch GAN
## cycleGAN

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNzI3NDgyODAsLTEzMjc4ODMwNjUsND
UwMTk0Nzk0LC0xMzUzMTMxNDE4LDE2MzA5NzU0NjcsMTE5Mzg5
NTA1MCwtMTE5MzUxNDU4Nyw5NTY2NzAwMDddfQ==
-->