...
### 损失  
  - 第一种  
	   - 判别器损失：  $E_{x \sim P_{rdata}}log(D(xy))+E_{x \sim P_{gG}}log(1-D(x)$  
...
### 主要内容  
  将原始GAN中的概率全改成了条件概率，  
  $\displaystyle\min_G \max _{D} \left \{  E_{x \sim P_{rdata}}logD(x|cy)+E_{x \sim P_{gG}}log(1-D(x|cG(z)))\right \}$   
   ？？？
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMzU5MzgxNjMsODc1MDY0OTcwLC0xND
Y1ODI2NDUwLDk1MDM0NzIwOCw2NTAyNzU2OTAsLTg5NDg5MjE3
NiwtMTg0NzI2MjU1Niw3NjEyMjkzMTksLTE1ODEzNzQ2MjIsOD
c4MjI3NjAzLC03NjExNTU1NjMsNTc1NDAzOTcsMTEwMjE2NjE5
LDE2NTI4Njk1NSwtMTgyMjExNzI2MSwxMzU0MzgwOTE2LC01NT
