...
### **主要内容**  
   ...
   - **多尺度判别器**    
      ...
      为了解决这个问题，本文提出了一个多尺度判别器。使用三个有相同结构的判别器D1,D2,D3，但对于不同尺度图像进行判别。
## DeblurGAN  
- **本文贡献**  
  - 提出了损失和架构  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM3NzcxNTE1MSwtODk0ODkyMTc2LC0xOD
Q3MjYyNTU2LDc2MTIyOTMxOSwtMTU4MTM3NDYyMiw4NzgyMjc2
MDMsLTc2MTE1NTU2Myw1NzU0MDM5NywxMTAyMTY2MTksMTY1Mj
g2OTU1LC0xODIyMTE3MjYxLDEzNTQzODA5MTYsLTU1MjE3NTM4
Nyw2NDMwMTEwODEsMjEzMDQ5Njg0NCwtMjE0NDc0NDAwMCw4OT
