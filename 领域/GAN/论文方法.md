...
- 改动  
  ...
  $max_{D}{E_{x,y}[logD(x,y)]+E_{x,z}[log(1−D(x,G(x,z)))]}$
## patch GAN  
   基于条件gan   
 - **方法**    
  该方法使用的是配对数据。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTIwODAzNjgxLDExMTc4MDE4ODEsLTE4MT
QyODExMzQsNjk5Mjc3NzcxLDIwNjA4ODk4MjIsMTIwNDg2NDE5
MywtNTU1Njc2OTc0LDY1OTQ3NTIxNywxMTAxNjA4NjMxLDY4ND
gyODQzMiwtMTI1Nzk4MjIwOCwtNDI0Njk0NzIyLC05MzI0NjA2
MjgsLTc1NzQwMTk5MSwtNzQ4NDExOTgxLDE4MzU3NzIzMTksMj
c2ODIwOTAsLTEzMjc4ODMwNjUsNDUwMTk0Nzk0LC0xMzUzMTMx
NDE4XX0=
-->