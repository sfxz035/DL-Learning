...
### **损失**  
   ...
   - object function为：  
    ...
    - 小结  
      GAN其实是一种相对于L1 loss更好的判别准则或者loss。有时候单独使用GAN loss效果好，有时候与L1 loss配合起来效果好。在pix2pix中，作者就是把L1 loss 和GAN loss相结合使用，因为作者认为L1 loss 可以恢复图像的低频部分，由于L1强制低频的正确性，从而促使GAN loss只关注高频部分，更准确的恢复图像的高频部分。另外通过patch
## cycleGAN  
   该网络针对非成对数据。   
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjIxNjQxOTMsMTAyMzgxNDE4MywxMjE1ND
Q0Njc3LDQ3ODUzMDgzMSwtMTU4NDgzMjI5MSwtMjAwNzgyOTMx
NCwxODU5NTc3NjA3LC0xNDM3NDY1OTI2LC0xOTQ2NDkyMzE3LD
ExMTc4MDE4ODEsLTE4MTQyODExMzQsNjk5Mjc3NzcxLDIwNjA4
ODk4MjIsMTIwNDg2NDE5MywtNTU1Njc2OTc0LDY1OTQ3NTIxNy
wxMTAxNjA4NjMxLDY4NDgyODQzMiwtMTI1Nzk4MjIwOCwtNDI0
Njk0NzIyXX0=
-->