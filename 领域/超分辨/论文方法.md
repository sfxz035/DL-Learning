...
- 针对SRCNN改进：
	...
	- SRCNN的Non-linear Mapping的参数量比较大  
	 ...
	 - 网络结构  
	   ...
	   - 扩张  
	     用1x1的卷积对特征维度进行上升，即增加特征通道数。输入通道数为s,输出为d。xiang'dang'yu
	   - 反卷积重建  
	   对比各种参数的结果，选取 m=4, d=56, s=12
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjY3OTYzNjgsNDI2MTI5NTU0LC00OTM3OT
A2NzcsLTkzODA4NDM0NSwzODQ0NzQ2NDIsLTE2NjkzODk0ODcs
OTM0NzU0MTAyLDI1MzAwNjc2OCwyMDQwMjk3NjIyXX0=
-->