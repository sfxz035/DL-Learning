...
- 解决方向：
	...
	- 可以输出vgg不同卷积层的输出作为loss约束，因为不同卷积层代表不同的感受野，而每个卷积层输出的feature map可以对多尺度的patch进行计算loss，从而达到
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NTM5MzYxNzcsMTM5NDE5NDM5MSwxMj
QyNjE0Nzg5LC01NTY0MjYzMTksNzYyMTc2NDcxLC05NDczMjY0
NzldfQ==
-->