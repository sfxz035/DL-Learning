...
- 网络结构     
  ...
  - 非对称损失函数   
     对于非盲去噪来说(例如BM3D和FFDNet)，输入的噪声等级与真实噪声等级一致时，去噪效果是最佳的；当输入噪声等级偏小的时候，去噪结果会有噪声残留；当输入噪声等级偏大的时候，依旧可以得到较好的结果。由此可以说明非盲去噪估计偏低的噪声等级参数比较敏感，而对于估计偏大的噪声等级参数更加鲁棒。
  -    
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI5MDIwNTkyMiwtMTA0MTQyNjEwOSwtMj
YzMTUxOTU3LC0xOTc2NzQzNDgzLC01MTI2NTYzODksLTYxNTUw
NDQzMSwxMTQ3Njc1MTU5LDEyMTIwNzExMzYsLTEwOTEyNTExMT
ksODUzOTgyOTgyLC03NDQ3MzY1MSwxMzE3Nzg2MDgzLC0xNzk2
NDM1NzEsLTQwODIxNzYxMSwtMTQ5ODg1MTg2MiwtODg2MzA3Nz
cwLDEyMzUxNDY0MjIsMTAyMTIyMTI0LC0xOTAzMjcyMjU1LDQ1
MDk5MDQ4OF19
-->