...
- **主要内容**    
   ...
   - **本文方法**     
      ...
      - 具体实现   
        ...
        softmax及之前的分支部分实现的就是f()操作，可以看出前面介绍的Embedded Gaussian就是该部分的完整操作（因为softmax操作会有一个分母，也就是C(x)，该部分中的softmax操作就完成了f()函数的幂计算和除以C(x)计算）,
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MDgzMzgzOTUsLTY3NTM0OTgyNywtMT
U5OTg3NjI0NywxMjM4Njc0ODA1LDE1MTUyMjY2MzAsLTI3MjAw
NzMyNSwxMDE4NDI0NTY5LC0xOTMxODk4MzY1LC05Nzc3MDUwMj
QsLTE4Njg0NjA5NywyNzI5MTQ0NDIsLTIwNDAxNjk4NDIsLTc1
Mjg5MDAsMTMxODI5MTk5MCw1NjE4MzI3MjMsNjc3NzMyMjQzLD
EzODMyNTQ3ODgsMzg2MTE2Mjc2LDY0ODY1NDkzOSwtMTQyMjE2
MTU4N119
-->