...
- 结构：   
   ...
   - 具体分析   
     U-Net的第一个特点是完全对称，采用了skip-connection操作，并且用了一个比较经典的思路，就是编码解码结构。   
     >码和解码（encoder-decoder），早在2006年就被Hinton大神提出来发表在了nature上，当时这个结构提出的主要作用并不是分割，而是压缩图像和去噪声   
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA5MzE2ODcwMCw5NTYxNjc1NDMsOTc2MT
U2MzM1LDE2NTQ1MDExNzQsLTU0NjYzOTM0LDUwNzUxMjkzNCwt
NDY4NzM3NDAsNDQxMDMzOTY3LC0xNTYzMDY1OSwtNTIzNjA1OD
E3LC0yMDc2OTAwNTY2LC02NzUzNDk4MjcsLTE1OTk4NzYyNDcs
MTIzODY3NDgwNSwxNTE1MjI2NjMwLC0yNzIwMDczMjUsMTAxOD
QyNDU2OSwtMTkzMTg5ODM2NSwtOTc3NzA1MDI0LC0xODY4NDYw
OTddfQ==
-->