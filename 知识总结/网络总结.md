...
- **网络结构**   
 ...
 - 特点   
   VGG16用多个3x3卷积代替Alexnet中的11x11卷积好处是，在达到了相同感受野的前提下减少了参数量，并且有更多的非线性变换（前者可以使用三次ReLU激活函数，而后者只有一次），学习能力更强。   
   1x1卷积的意义主要在于线性变换，然后通过relu非线性处理，增强非线性表达能力。而输入通道数和输出通道数不变，没有发生降维。
### GoogleNet  
#### inception V1
- **网络结构**  
  - **inception结构**  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3OTA2NTk3NjksMTQ4NTg4Njc0OSw4Mj
E1NzA3OTksMTc4MDc1MjgyNywxNTk1Mzc5OTEsLTExMzQ1Mjcz
NjMsMTQyMTM2Mzg2MywxNjIzNTcyNDg5LC0zNTU1NjgwMjksLT
k2Njc0MzczMSwxNjE1NTYxOTczLDE5NDY0MTgyNjMsNTQyOTQx
ODQxLC0yODA2NzUyMDUsMjA5MDk5MTAzOCw3NTI4ODQ3NjIsLT
U1Mjc1MzQ5NiwxMjI0MzYwOTUsMjQ2MjYzNzY1LDkzMjk4NzIy
NF19
-->