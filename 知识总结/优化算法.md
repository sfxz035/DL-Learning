...
## 自适应学习率优化算法  
  ...
  - **AdaDelta**  
    ...
    - 算法描述  
        1. $E[g^2]_t=γE[g^2]_{t−1}+(1−γ)g^2_t$  ，$RMS[g]t=√E[g^2]t+ϵ$  
        3. $E[Δθ^2]_t=γE[Δθ^2]_{t−1}+(1−γ)Δθ^2_t$，$RMS[Δθ]_t=√E[Δθ^2]_t+ϵ$
    - 性能
  - 

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE3Mzc4ODEyNywtNzQ4NTA0Mjk1LC0xOD
