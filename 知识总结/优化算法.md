...
## 自适应学习率优化算法  
  ...
  - **AdaDelta**  
    ...
    - 算法描述  
        ...
        3. $E[Δθ^2]_t=γE[Δθ^2]_{t−1}+(1−γ)Δθ^2_t$，$RMS[Δθ]_t=\sqrt{E[Δθ^2]_t+ϵ}$
        4. 因为$RMS[Δθ]_t$是未知的，故用$RMS[Δθ]_{t−1}来更新$：  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAwMDg2NDkyOCwtNzQ4NTA0Mjk1LC0xOD
