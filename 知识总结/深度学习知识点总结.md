...
- ReLU   
   - 优点  
      ReLU可以解决梯度消失   
   - 缺点   
     当损失过大，或者学习率过大时，也就是梯度过大时，会造成死神经元，之后的梯度计算为零，参数不再更新。ReLU左侧输出为零造成的，使得输入数据在经过这个神经元的时候，输出值小于0，从而经过激活函数的时候为0，从此不再更新
### **CNN参数计算以及时间复杂度**      
 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjQ4MTkxNzUzLDE2NzY4NDk4NjAsMTQ5ND
U2ODcxNywxNTE2MTAzOTgyLDE0MzUzOTU4MjIsMTI1NzYwNTM1
LDI4NTYwODM4NiwtNTEwMTc0NzY1LDE4NzM2ODI2ODhdfQ==
-->