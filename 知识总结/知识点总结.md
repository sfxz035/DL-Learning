...
#### **计算方式**  
  **逐channel地计算**同一batch中所有数据的mean和variance，再对input使用mean和variance进行归一化，最后的输出再进行线性平移，得到batch_norm的最终结果。  
  ...
  ```  
  #### 均值和方差的更新方式  
  train阶段每个batch计算的mean/variance采用指数加权平均来得到test阶段mean/variance的估计。
#### batchnorm优点
	1. 避免了梯度消失和梯度爆炸
	2. 加速网络的收敛
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE2NTA5NzgwNywtMjg3ODA1OTIsMTYxOT
M1NTMzOSwtMTYzMzg2NzYwNSwtMTM0Mzc2MDU5NywxMjg5MTY0
NTk3LDM3MjE4NzU3NiwxOTQzMzM5NjY1LC0xNjYyOTQyOTg0LC
0yNDkyNTkyNTcsLTg0OTUzODAzNiwtMTMxMDQzMjMxNSwtOTQ1
MzI1ODkxLC0xNDQ2Nzk0NTQsLTg3OTU3NTUzOCwtNzEyMTgxND
AxLDEyNTQwMjk0MTksLTIwODg3NDY2MTIsMTg0NDI5NTkzNCwt
OTkzNTMwNDA3XX0=
-->