...
- 图解  
  深度网络中的数据维度一般是[N, C, H, W]或者[N, H, W，C]格式。图中C代表通道，N代表样本数，即batchsize。 
----
#### 问题
...
2. 什么时候可以对所有样本一起标准化，什么时候分别对单个数据进行标准化？  
   ...
   但是**图像风格化**中，生成结果主要依赖于某个图像实例，所以对整个batch归一化不适合图像风格化中，因而对HW做归一化。可以加速模型收敛，并且保持每个图像实例之间的独立。
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNTUxMjQ3MzksLTE1OTQwODIzMzIsMT
A3MDcxMzk1NSwtMTQ3NzkyOTEyLDczMTczNzU4NCwxMzMyMTAy
MjU5LC00MTE4NTk3OTksMTU5NjQ5NzE0NywtMTg2ODQwMTYxNC
wtMTcwMTgxNjA1Myw0MTAzMjg2NSwxMjc0NjM5NjI5LC0xNjM2
ODU4NDEwLC0xMDM3NjY0OTYyLDQyMjkwMDQzOCwtMjg3ODA1OT
IsMTYxOTM1NTMzOSwtMTYzMzg2NzYwNSwtMTM0Mzc2MDU5Nywx
Mjg5MTY0NTk3XX0=
-->