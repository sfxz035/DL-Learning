...
2. 什么时候可以对所有样本一起标准化，什么时候分别对单个数据进行标准化？  
   ...
   但是**图像风格化**中，生成结果主要依赖于某个图像实例，所以对整个batch归一化不适合图像风格化中，因而对HW做归一化。可以加速模型收敛，并且保持每个图像实例之间的独立。
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNjA0MDMxNjksMTQwODE2ODQ1Niw5Nj
E4OTI3NTUsMjI4MzMwNzYsLTc2MTIyNTA1OCwtMTU5NDA4MjMz
MiwxMDcwNzEzOTU1LC0xNDc3OTI5MTIsNzMxNzM3NTg0LDEzMz
