...
- 标准化/白化问题  
   为什么白化可以加快训练呢  
   参数初始化都是位于零左右的值，而白化后可以将数据分布拉回零范围左右，无疑可以加快学习的速度。
...
3.为什么要标准化
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjUxMDQ0MzkyLC0yMDQyOTIzMzg0LC0yMD
k2NDY3NDIzLDMyNTkyNTA1Nyw5ODc0NTg2OSwxNjYwOTE4MDI2
LDE0MDgxNjg0NTYsOTYxODkyNzU1LDIyODMzMDc2LC03NjEyMj
