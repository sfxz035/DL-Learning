...
![enter image description here](https://github.com/sfxz035/DL-Learning/raw/master/picture/17196290-08c9aa4f6ab47e37.png)   
 ...
 - 适用范围：
   ...
   - BN与IN：  
     ...
     - IN  
       IN适用于生成模型，比如图片风格迁移。因为IN是对每张图片生成的结果主要依赖于某个图像实例，
...
2. 什么时候可以对所有样本一起标准化，什么时候分别对单个数据进行标准化？  
   ...
   但是**图像风格化**中，生成结果主要依赖于某个图像实例，所以对整个batch归一化不适合图像风格化中，因而对HW做归一化。可以加速模型收敛，并且保持每个图像实例之间的独立。
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzU4MjUwODUwLC03NjEyMjUwNTgsLTE1OT
QwODIzMzIsMTA3MDcxMzk1NSwtMTQ3NzkyOTEyLDczMTczNzU4
NCwxMzMyMTAyMjU5LC00MTE4NTk3OTksMTU5NjQ5NzE0NywtMT
g2ODQwMTYxNCwtMTcwMTgxNjA1Myw0MTAzMjg2NSwxMjc0NjM5
NjI5LC0xNjM2ODU4NDEwLC0xMDM3NjY0OTYyLDQyMjkwMDQzOC
wtMjg3ODA1OTIsMTYxOTM1NTMzOSwtMTYzMzg2NzYwNSwtMTM0
Mzc2MDU5N119
-->