...
### **权重初始化**   
 ...
 - **全零初始化**   
      ...
      参数全部初始化为零的话会导致每层的不同节点参数全部都得到相同更新，不管进行多少轮正向传播以及反向传播，每层的不同节点之间的参数都是一样的。   
...
### **CNN****参数计算以及时间复杂度**    
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1Mjk3OTI0Miw0OTM5MTgxOCw5MTIwNT
E1MDIsLTE1NzI5NTI2MzQsLTE5MzAyMDg3MjIsLTEwNDM3ODE4
NDIsMTczNzM5OTA2Nyw3ODI1MTAyMDYsLTEzMzI0NzQwNDAsLT
EyNTE1NTc1OTAsMTM3NTUzMTUyMSw0Nzk0OTI3MTYsLTQyNjgx
MzEwMSwxMDMzOTUxNTk4LDUxNzExNDk3OSwxMDY4MzQzOTIwLD
UzMTk5MjM0LC05MDg2MjI1NTMsNzM0ODg0MTI2LDc5OTI3NTM5
MV19
-->