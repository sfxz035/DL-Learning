...
### **权重初始化**   
   参数初始化的目的是为了让神经网络在训练过程中学习到有用的信息，这意味着参数梯度不应该为0。我们把这两个条件总结为参数初始化条件    
...
### **CNN****参数计算以及时间复杂度**    
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDc5NDE0NDQxLC0yMDczNjAwMTA2LDIwNT
gyNjkxNCw0OTM5MTgxOCw5MTIwNTE1MDIsLTE1NzI5NTI2MzQs
LTE5MzAyMDg3MjIsLTEwNDM3ODE4NDIsMTczNzM5OTA2Nyw3OD
I1MTAyMDYsLTEzMzI0NzQwNDAsLTEyNTE1NTc1OTAsMTM3NTUz
MTUyMSw0Nzk0OTI3MTYsLTQyNjgxMzEwMSwxMDMzOTUxNTk4LD
UxNzExNDk3OSwxMDY4MzQzOTIwLDUzMTk5MjM0LC05MDg2MjI1
NTNdfQ==
-->