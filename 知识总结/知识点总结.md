...
- **Xaiver****参数初始化方法**      
   ...
   **简介**：Xavier追求的，就是让我们每一层的输入（也是上一层的输出）都能控制一定范围内，保持输入和输出方差一致。这样就不会在激活函数那一块产生太多的问题，也不会导致梯度太小。适用于激活函数sigmoid和tanh。公式如下：
...
### **CNN****参数计算以及时间复杂度**     
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU3MjgzNTM5NywxOTgzNjc0NTU2LDUyNj
c3OTk2NSwtMTIzNzc3OTI3NSwtNjcyNDcwNjg5LC0yMDczNjAw
MTA2LDIwNTgyNjkxNCw0OTM5MTgxOCw5MTIwNTE1MDIsLTE1Nz
I5NTI2MzQsLTE5MzAyMDg3MjIsLTEwNDM3ODE4NDIsMTczNzM5
OTA2Nyw3ODI1MTAyMDYsLTEzMzI0NzQwNDAsLTEyNTE1NTc1OT
AsMTM3NTUzMTUyMSw0Nzk0OTI3MTYsLTQyNjgxMzEwMSwxMDMz
OTUxNTk4XX0=
-->