...
该公式使间隔尽量大，同时使误分类点的个数尽量小，C是调和两者的系数。同时约束间隔大于等于（1-$\xi_i$）。
 - 对偶问题  
  ...
  - 合折页损失   
    $L_(y) = max(0 , 1 – t⋅y)$   
    其中，y是预测值(-1到1之间)，t为目标值(1或 -1)。其含义为，y的值在 -1到1之间即可
  #### **小结**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM3MTM0OTMyMiwzMTc0MjY2NzgsLTIwMz
A5Nzg2NywxMzI3NDIxODI1LC0xMDYwOTA1NTUzLC0xNTgyNDA1
MDcyLDE5NTQzMTg1ODMsLTE5MDIzNzg5NzksLTkwMDA3MzMxLD
ExNzI1NDM3ODksMjA3NjIyMzM2NSwxNzc0NTk5MDI1LC02NzEy
NzQ0NCwyMjk2ODE2NTQsMTE0ODIzODk0MCwxNDA1NDc5ODMyLD
E2NDA5NzYzNjcsLTE5MDc4NzAyOTcsLTE4MjIwNzMwNjYsNDMw
NzEzMzk5XX0=
-->