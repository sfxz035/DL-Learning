	...
	-  **CART树的构建**：  
		...
		- **划分输入空间**：  
		  - 输入空间的属性值为连续值  
		    ...
		    根据是否大于某个中间值可以将属性划分为两类。而具体选哪个中间值作为划分，使基尼指数或者方差最小
		  - 
		- 
	- 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTcyMzIyMjM3MiwtNzIwOTYwMjM3LDg0Mz
U5ODc3NywxMTYxNTI1ODc3LDk5NDc4ODkxMywtMzI2MTMwOTgx
LC0xOTQwODQxNzAxLDE3NjM2NDEyMDMsLTY1NzE5Njg0OCwtMT
