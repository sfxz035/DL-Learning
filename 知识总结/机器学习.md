...
- **CART算法**
	...
	-  **CART树的构建**：  
		...
		- **划分输入空间**：  
		  - 输入空间的属性值为连续值  
		    采用**二分**的思想。由于我们的数据集是有限的，即使是连续值，属性a在数据集中也只出现了有限个确定的值。记为（$a_1$,$a_2$，...，$a_n$）
		  - 
		- 
	- 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTczMjQ5MjAyNywxMTYxNTI1ODc3LDk5ND
c4ODkxMywtMzI2MTMwOTgxLC0xOTQwODQxNzAxLDE3NjM2NDEy
MDMsLTY1NzE5Njg0OCwtMTYzNDUzMTI0NCwxMzkwMTgxNjEwLC
03NDkzMjUxOTYsLTg5NDk2NDE4NSwxOTI0ODUyNjA5LDg4OTM1
Njc2MSwxMDYwMzE4MTI5LC04MzQwMzkxOTksMTU2MDU2NDgzOC
wtNzk5Mzg3ODE0LC0zMzgxMTM5NDAsLTExMjY4NjMyMzYsNTM2
MTY4Nzg5XX0=
-->