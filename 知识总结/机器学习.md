		...
		- **假设输入空间已经划分**： 
			...
			- 回归树——输出结果为连续型数据  
			  ...
			  方差公式为： 		 ![enter image description here](https://github.com/sfxz035/DL-Learning/raw/master/picture/1556618509%281%29.jpg)  
			    ...
			    对于含有NN个样本的样本集SS，根据属性AA的第ii个属性值，将数据集SS划分成两部分，则划分成两部分之后
		- **划分输入空间**：  
		  
		- 
	- 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwODI3MzUyMzcsMTc2MzY0MTIwMywtNj
U3MTk2ODQ4LC0xNjM0NTMxMjQ0LDEzOTAxODE2MTAsLTc0OTMy
NTE5NiwtODk0OTY0MTg1LDE5MjQ4NTI2MDksODg5MzU2NzYxLD
EwNjAzMTgxMjksLTgzNDAzOTE5OSwxNTYwNTY0ODM4LC03OTkz
ODc4MTQsLTMzODExMzk0MCwtMTEyNjg2MzIzNiw1MzYxNjg3OD
ksOTgxMjk3NDA3LC0yNzkyNTUzNDEsMTA3MTUyMjI5MSwtNDc5
Mzk5MjYxXX0=
-->