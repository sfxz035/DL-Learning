...
- **方法过程**：  
  - i)	先从初始训练集训练出一个基学习器；
  - ii)  再根据基学习器的表现**对训练样本分布进行调整**，使得先前基学习器做错的训练样本在后续受到更多关注；
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTAxMTMwODg4LC03NjkyMzcyNDcsMTEwMD
...
MjMzMywzMDIyNjg0MjEsLTcyOTIwNTk3OSwxNTk4NjcyMTEsLT
IyMjA5MjMwNiwyOTI3OTQ2MjIsLTExMjk4NjkyMTEsLTMyNjAw
NTUxNV19
-->