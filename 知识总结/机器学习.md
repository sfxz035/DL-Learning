...
-  **逻辑回归简介及来由**    
	...
	LR思想：通过对分类边界建立回归公式，以此进行分类，输出分类jieLR模型可以被认为就是一个被Sigmoid函数（logistic方程）所归一化后的线性回归模型。  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3Nzk3MjI2ODIsLTEzNjc2Mzk5ODEsMT
E5NDk5MjQxOCwxNzkwMTE2NzcwLDEzOTUyMTczOTAsOTQ3ODUz
NTMyLDQzODg0NDkyOCwtMzcxMzQ5MzIyLDMxNzQyNjY3OCwtMj
AzMDk3ODY3LDEzMjc0MjE4MjUsLTEwNjA5MDU1NTMsLTE1ODI0
MDUwNzIsMTk1NDMxODU4MywtMTkwMjM3ODk3OSwtOTAwMDczMz
EsMTE3MjU0Mzc4OSwyMDc2MjIzMzY1LDE3NzQ1OTkwMjUsLTY3
MTI3NDQ0XX0=
-->