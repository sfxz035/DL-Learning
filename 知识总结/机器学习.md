...
- **CART算法**
	...
	-  **CART树的构建**：  
		- **假设输入空间已经划分**： 
			...
			- 回归树——输出结果为连续型数据  
			  选取是方差最小的特征作为分裂二叉树的分裂特征。方差越小，说明二分之后的子样本的“差异性”越小。方差公式为：  
			  ![enter image description here](https://github.com/sfxz035/DL-Learning/raw/master/picture/1556618509%281%29.jpg)  
	...
	- 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkyNDM1NDIsMTc2MzY0MTIwMywtNjU3MT
k2ODQ4LC0xNjM0NTMxMjQ0LDEzOTAxODE2MTAsLTc0OTMyNTE5
NiwtODk0OTY0MTg1LDE5MjQ4NTI2MDksODg5MzU2NzYxLDEwNj
AzMTgxMjksLTgzNDAzOTE5OSwxNTYwNTY0ODM4LC03OTkzODc4
MTQsLTMzODExMzk0MCwtMTEyNjg2MzIzNiw1MzYxNjg3ODksOT
gxMjk3NDA3LC0yNzkyNTUzNDEsMTA3MTUyMjI5MSwtNDc5Mzk5
MjYxXX0=
-->