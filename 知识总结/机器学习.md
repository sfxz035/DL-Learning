...
实际上分类误差率就等于所有**分类错误的数据的权值之和**
		...
		回归问题算法和以上的分类算法大体一致，两点区别：1. 误差率计算的不同，回归问题对每个样本的计算相对误差(误差公式可选为平方差，指数误差等等)，再得到学习器的误差率。2. 强学习器的集成册罗
### **Bagging，Boosting二者之间的区别**

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE0MTA4ODUyOCwxMTg2NDk0OTczLC00ND
k2ODYwMCwxOTkzODIxOTU0LDIxMTg5NjQyNTIsMjA0MDcyNDMx
NiwxNDcyNTMwMTEsMjkxMzIzMTI2LC03NjkyMzcyNDcsMTEwMD
k0MzMzOCwtMTYyOTAxNjE3OCwtMTA4MDcyOTg4NCw0MTc1NDM5
MDMsLTE1MjEwNTMxNjksNTk3MDAxMzI1LDE2NjY3MzMxNDcsLT
QwMTQxODgzNywtMTE0MjEyNjEyMCw0NjA3MDAzOCwtMTkxMzMy
MjMzM119
-->