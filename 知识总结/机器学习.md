   ...
   - **最大化几何间隔**  
	  ...
	  **固定函数间隔为1** 时，正负支持向量又满足以下公式：  
	   ...
	   2. 推导方法二  
	    ...
	    $\begin{aligned} &{\color{Red} \underset{w,b}{\max} } \quad\frac{\hat{\gamma}}{{\color{Red} \left | w \right |}} \ & \mathrm{s.t.}\quad, y_i(wx_i+b) \geq \hat{\gamma}_i,\quad i=1,2,\cdots,N \end{aligned}$
	   - 两者兼顾  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQxNTQxMzIxMCw5NzUxMzcyODYsMTczND
