...
![enter image description here](https://github.com/sfxz035/DL-Learning/raw/master/picture/1556011439%281%29.jpg)
   ...
   - **最大化几何间隔**  
	  ...
	  **固定函数间隔为1** 时，正负支持向量又满足以下公式：  
	   ...
	   2. 推导方法二  
	      最大化几何间隔：  
	     $\begin{aligned} &{\color{Red} \underset{w,b}{\max}} \quad\gamma \ & \quad, (x_i{{\color{Red} \left | w \right |}}) \geq \gamma,\quad i=1,2,\cdots,N \end{aligned}$
	   - 两者兼顾  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNTUwMjEwOTMsOTc1MTM3Mjg2LDE3Mz
