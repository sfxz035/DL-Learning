...
- **CART算法**
	...
	-  CART树的构建：  
		- 假设输入空间已经划分： 
			- 分类树——待预测结果为离散型数据
			  1）遍历所有特征条件下的基尼指数，选择最小的基尼指数特征作为二叉树左右节点的分裂特征。特征条件下的基尼指数越小，说明二分之后的样本越纯净。
			- 回归树——待预测结果为连续型数据
		- 划分输入空间，裂分成二叉树：
	- 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3Nzk0MDIwNzksLTY1NzE5Njg0OCwtMT
YzNDUzMTI0NCwxMzkwMTgxNjEwLC03NDkzMjUxOTYsLTg5NDk2
NDE4NSwxOTI0ODUyNjA5LDg4OTM1Njc2MSwxMDYwMzE4MTI5LC
04MzQwMzkxOTksMTU2MDU2NDgzOCwtNzk5Mzg3ODE0LC0zMzgx
MTM5NDAsLTExMjY4NjMyMzYsNTM2MTY4Nzg5LDk4MTI5NzQwNy
wtMjc5MjU1MzQxLDEwNzE1MjIyOTEsLTQ3OTM5OTI2MSwtNTQw
NjYzODk3XX0=
-->